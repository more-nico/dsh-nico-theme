window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		const css$2 = ".Xp-nsa_group{border-bottom:1px solid var(--dsw-alias-border-l2);flex-direction:column;gap:14px;padding:8px 0 16px;display:flex}.Xp-nsa_subGroup{flex-direction:column;gap:8px;display:flex}.Xp-nsa_subTitle{color:var(--dsw-alias-label-primary);font-size:13px;font-weight:600;line-height:20px}.Xp-nsa_controls{flex-direction:column;gap:10px;display:flex}.Xp-nsa_row{align-items:center;gap:10px;display:flex}.Xp-nsa_rowLabel{width:92px;color:var(--dsw-alias-label-secondary);flex:none;font-size:12px;line-height:18px}.Xp-nsa_inlineLabel{color:var(--dsw-alias-label-secondary);flex:none;font-size:12px;line-height:18px}.Xp-nsa_rowHint{color:var(--dsw-alias-label-tertiary);margin-top:-4px;margin-left:102px;font-size:12px;line-height:18px}.Xp-nsa_groupHint{color:var(--dsw-alias-label-tertiary);margin-top:-4px;font-size:12px;line-height:18px}.Xp-nsa_knobHint{color:var(--dsw-alias-label-tertiary);margin-top:-4px;margin-left:102px;font-size:12px;line-height:18px}.Xp-nsa_toggle,.Xp-nsa_toggleOn{border:1px solid var(--dsw-alias-border-l2);height:28px;color:var(--dsw-alias-label-primary);cursor:pointer;background:0 0;border-radius:14px;align-items:center;gap:6px;padding:0 10px 0 6px;font-size:12px;line-height:18px;display:inline-flex}.Xp-nsa_toggle:hover{background:var(--dsw-alias-interactive-bg-hover)}.Xp-nsa_toggleOn{background:var(--dsw-alias-state-business-tertiary);color:var(--dsw-alias-state-business-primary);border-color:#0000}.Xp-nsa_check{justify-content:center;align-items:center;width:16px;height:16px;display:inline-flex}.Xp-nsa_knob{align-items:center;gap:10px;display:flex}.Xp-nsa_knobLabel{width:92px;color:var(--dsw-alias-label-secondary);flex:none;font-size:12px;line-height:18px}.Xp-nsa_slider{min-width:0;accent-color:var(--dsw-alias-state-business-primary);flex:1}.Xp-nsa_numberWrap{flex:none;align-items:center;gap:4px;display:inline-flex}.Xp-nsa_number{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-2);width:56px;height:26px;color:var(--dsw-alias-label-primary);text-align:right;border-radius:8px;padding:0 6px;font-size:12px;line-height:18px}.Xp-nsa_number::-webkit-outer-spin-button,.Xp-nsa_number::-webkit-inner-spin-button{-webkit-appearance:none;margin:0}.Xp-nsa_unit{width:18px;color:var(--dsw-alias-label-tertiary);flex:none;font-size:12px;line-height:18px}.Xp-nsa_segmented{border:1px solid var(--dsw-alias-border-l2);border-radius:8px;display:inline-flex;overflow:hidden}.Xp-nsa_seg,.Xp-nsa_segActive{height:26px;color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:none;padding:0 12px;font-size:12px;line-height:18px}.Xp-nsa_seg+.Xp-nsa_seg,.Xp-nsa_segActive+.Xp-nsa_seg,.Xp-nsa_seg+.Xp-nsa_segActive{border-left:1px solid var(--dsw-alias-border-l2)}.Xp-nsa_segActive{background:var(--dsw-alias-state-business-tertiary);color:var(--dsw-alias-state-business-primary)}.Xp-nsa_wallpaperPick{align-items:center;gap:10px;display:flex}.Xp-nsa_fileInput{display:none}.Xp-nsa_pickButton{border:1px solid var(--dsw-alias-border-l2);height:26px;color:var(--dsw-alias-label-primary);cursor:pointer;background:0 0;border-radius:8px;padding:0 12px;font-size:12px;line-height:18px}.Xp-nsa_pickButton:hover{background:var(--dsw-alias-interactive-bg-hover)}.Xp-nsa_deleteButton{border:1px solid var(--dsw-alias-border-l2);height:26px;color:var(--dsw-alias-label-error);cursor:pointer;background:0 0;border-radius:8px;padding:0 12px;font-size:12px;line-height:18px}.Xp-nsa_deleteButton:hover{background:var(--dsw-alias-interactive-bg-hover)}";
		const tagId$2 = "dsh-nico-theme/AquaAppearanceRow.module.css";
		...
		var AquaAppearanceRow_module_css_default = {
			...
			"group": "Xp-nsa_group",
			"groupHint": "Xp-nsa_groupHint",
			"inlineLabel": "Xp-nsa_inlineLabel",
			"knob": "Xp-nsa_knob",
		...
		*/
		function AquaAppearanceRow(props) {
			const { t, setMode, setBlur, setFrost, setFluidHue, setFluidDepth, setBgBrightness, setBackground, setWallpaper, setWhale, setCritters, setMesh, setSpotlight, setPress, setWallpaperBlur, setWallpaperFrost, setVideoBlur, setVideoBrightness, authorizeVideo, setRefract, setRefractOn, setScrim, setScrimBlur, setRim, useStore } = props;
			const enabled = useStore((s) => s.enabled);
							...
							children: [
								...
								/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
										...
										type: "button",
										className: refractOn ? AquaAppearanceRow_module_css_default.toggleOn : AquaAppearanceRow_module_css_default.toggle,
										...
										children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
											...
											children: refractOn && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconCheckOutline16, {})
							...
							children: [
								...
								/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
										...
										type: "button",
										className: rim ? AquaAppearanceRow_module_css_default.toggleOn : AquaAppearanceRow_module_css_default.toggle,
										"aria-pressed": rim,
										onClick: () => {
											setRim(!rim);
										},
										children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
											className: AquaAppearanceRow_module_css_default.check,
											children: rim && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconCheckOutline16, {})
